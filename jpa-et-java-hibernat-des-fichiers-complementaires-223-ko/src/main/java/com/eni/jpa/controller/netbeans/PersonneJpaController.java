...
public class PersonneJpaController implements Serializable {
    ...
    public void create(Personne personne) {
        ...
        try {
            ...
            if (personneDetail != null) {
                personneDetail = em.getReference(personneDetail.getClass(), personneDetail.getIdPersonne());
            ...
            em.persist(personne);
            if (personneDetail != null) {
                Personne oldPersonneOfPersonneDetail = personneDetail.getPersonne();
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            List<String> illegalOrphanMessages = null;
            PersonneDetail personneDetailOrphanCheck = personne.getPersonneDetail();
            if (personneDetailOrphanCheck != null) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("This Personne (" + personne + ") cannot be destroyed since the PersonneDetail " + personneDetailOrphanCheck + " in its personneDetail field has a non-nullable personne field.");
            }
